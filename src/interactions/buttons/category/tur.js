...
module.exports = {
	...
	async execute(interaction) {
		...
		const message = await interaction.reply({ephemeral: true, content: "Bir talep kategorisi seçin", components: [ticketType],fetchReply: true})
